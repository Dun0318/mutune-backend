...
웹 환경에서 악보를 변환·정렬하고,  
키 조절, 템포 변경, 향후 자동 믹싱까지 지원하는 것을 목표로 설계된 프로젝트입니다.

현재는 전체 서비스 중 **악보 처리 기능을 우선 개발하고 있는 단계**이며,  
아직 완성 단계는 아니지만 핵심 처리 구조를 구현하고 지속적으로 개선 중입니다.

PDF 악보를 업로드하면 MusicXML로 변환하고,  
코드와 가사를 음악적 시간 기준에 맞게 정렬하여  
웹에서 다시 렌더링 가능한 구조로 재구성합니다.
